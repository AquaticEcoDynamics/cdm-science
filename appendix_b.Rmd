...
#theSheet <- append(theSheets,'Validation 2013 2016',0)
kbl(theSheet, caption = "Model results for Generation 1.5", align = "l",escape = F,col.names = 'Validation 2017 2022', ) %>%
row_spec(0, background = "#14759e", bold = TRUE, color = "white") %>%
  kable_styling(full_width = T,font_size = 10) %>%
    scroll_box(fixed_thead = FALSE)
```
...
theSheet <- paste("<",'a href="HTML/Gen15/',theSheet_Names,'"',">",theSheet_Names,"<",'/a',">", sep = "")
#theSheet <- append(theSheets,'Validation 2013 2016',0)
kbl(theSheet, caption = "Model results for Generation 2", align = "l",escape = F,col.names = 'Validation 2017 2022', ) %>%
row_spec(0, background = "#14759e", bold = TRUE, color = "white") %>%
  kable_styling(full_width = T,font_size = 10) %>%
    scroll_box(fixed_thead = FALSE)
```
...
#theSheet <- append(theSheets,'Validation 2013 2016',0)
kbl(theSheet, caption = "Model SWAN Wave Comparison", align = "l",escape = F,col.names = 'Validation 2017 2022', ) %>%
row_spec(0, background = "#14759e", bold = TRUE, color = "white") %>%
  kable_styling(full_width = T,font_size = 10) %>%
    scroll_box(fixed_thead = FALSE)
```
