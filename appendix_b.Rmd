...
<div class="tab">
  ...
  <button class="tablinks" onclick="opentab(event, 'COMP')">HCHB Generation</button>
</div>
...
kbl(theSheet, caption = "Model results for longterm_performance_2013_2019", align = "l",escape = F,col.names = 'Validation 2019 2021', ) %>%
row_spec(0, background = "#14759e", bold = TRUE, color = "white") %>%
  kable_styling(full_width = T,font_size = 10) %>%
    scroll_box(fixed_thead = FALSE)
```
