...
library(readxl)
library(rmarkdown)
theSheet_Names <- list.files(path = "HTML/Performance/MULTI/HTML", pattern = NULL, all.files = FALSE,
           full.names = FALSE, recursive = FALSE,
           ignore.case = FALSE, include.dirs = FALSE, no.. = FALSE)
theSheet <- paste("<",'a href="HTML/Performance/MULTI/HTML/',theSheet_Names,'"',">",theSheet_Names,"<",'/a',">", sep = "")
#theSheet <- append(theSheets,'Validation 2013 2016',0)
...
```{r A-waveanalysis, echo=FALSE, message=FALSE, warning=FALSE}
libratheSheet_Names <- list.files(path = "HTML/WAVES/HTML", pattern = NULL, all.files = FALSE,
           full.names = FALSE, recursive = FALSE,
           ignore.case = FALSE, include.dirs = FALSE, no.. = FALSE)

theSheet <- paste("<",'a href="HTML/WAVES/HTML/',theSheet_Names,'"',">",theSheet_Names,"<",'/a',">", sep = "")
