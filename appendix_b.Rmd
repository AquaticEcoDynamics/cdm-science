...
kbl(theSheet, caption = "Model results for GEN 2.1 nWV nSDG simulation (Generation 2 model without wave or dynamic sediment modules engaged.)", align = "l",escape = F,col.names = c("Generation 2  (TIME SERIES)","Generation 2 (TRANSECT)"), ) %>%
