...
The Generation 0 model was run between 2017 - 2020 using the base case and two management scenarios. For details of model application and results please refer to [Brookes et al. 2022](https://www.frontiersin.org/articles/10.3389/fenvs.2022.796623/full). 
