...
kbl(theSheet[,1:6], caption = "Environmental thresholds for *Ruppia* life-stages based on past literature review and expert judgement.", align = "c",escape = F) %>%
row_spec(0, background = "#14759e", bold = TRUE, color = "white") %>%
  kable_styling(bootstrap_options = "basic",full_width = T,font_size = 10)
#  scroll_box(fixed_thead = FALSE)
```
...
kbl(theSheet[,1:6], caption = "Environmental thresholds for *Ruppia* life-stages based on recent literature review, HCHB survey data and expert judgement. Refer to Section 8.1.3.1 and Appendix C for more details on each function and rationale.", align = "c",escape = F) %>%
row_spec(0, background = "#14759e", bold = TRUE, color = "white") %>%
  kable_styling(bootstrap_options = "basic",full_width = T,font_size = 10)
#  scroll_box(fixed_thead = FALSE)
```
