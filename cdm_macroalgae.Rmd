...
The model results are shown in  Figure \@ref(fig:dev-ulva14) - \@ref(fig:dev-ulva15) for the 2020 dataset, and Figure \@ref(fig:dev-ulva16) - \@ref(fig:dev-ulva17) for the 2021 dataset. Comparison of zone averaged modelled and observed data in 2020 - 2021 is shown in Figure  \@ref(fig:dev-ulva18).
