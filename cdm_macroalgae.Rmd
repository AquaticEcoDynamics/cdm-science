...
```{r dev-pic10, echo = FALSE, out.width='50%', fig.show='hold',fig.align='default', fig.cap = "Filamentous Algae sampling sites for monitoring program prior to 2020. Agency/program code under each map corresponds to those listed in Table 6.1. Turquoise outline represents the model boundary."}

knitr::include_graphics("images/dev/algaesites_May2017.png")
...
```{r dev-pic14, echo = FALSE, out.width='100%', fig.align='center', fig.cap = "Comparison of Observed and Simulated Ulva biomass (g DW/m2) for 2020."}
