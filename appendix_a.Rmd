...
# There are 16 groups to be added...
  ...
  pack_rows(theSheetGroups[10],
            min(which(theSheet$Group == theSheetGroups[10])),
            max(which(theSheet$Group == theSheetGroups[10])),
            background = '#ebebeb') %>%   

  pack_rows(theSheetGroups[11],
            min(which(theSheet$Group == theSheetGroups[11])),
            max(which(theSheet$Group == theSheetGroups[11])),
            background = '#ebebeb') %>%

  pack_rows(theSheetGroups[12],
            min(which(theSheet$Group == theSheetGroups[12])),
            max(which(theSheet$Group == theSheetGroups[12])),
            background = '#ebebeb') %>%

  pack_rows(theSheetGroups[13], 
            min(which(theSheet$Group == theSheetGroups[13])),
            max(which(theSheet$Group == theSheetGroups[13])),
            background = '#ebebeb') %>%

  pack_rows(theSheetGroups[14],
            min(which(theSheet$Group == theSheetGroups[14])),
            max(which(theSheet$Group == theSheetGroups[14])),
            background = '#ebebeb') %>%

  pack_rows(theSheetGroups[15],
            min(which(theSheet$Group == theSheetGroups[15])),
            max(which(theSheet$Group == theSheetGroups[15])),
            background = '#ebebeb') %>%

  pack_rows(theSheetGroups[16],
            min(which(theSheet$Group == theSheetGroups[16])),
            max(which(theSheet$Group == theSheetGroups[16])),
            background = '#ebebeb') %>%
