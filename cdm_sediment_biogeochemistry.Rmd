...
The above model approach is broadly used in lakes, ocean and estuarine environments, but there remain few cases in shallow lagoons (Paraska et al. 2014). Three main developments have been undertaken to adapt the code-base to the Coorong application:
...
```{r dev-pics6, echo = FALSE, out.width='75%', class = "text-image",fig.show='hold',fig.align='center', fig.cap = "Map of the five zones in the lake for the zone tracer experiment. Zones 3 and 5 had active sediment zones and Zone 2 had a constant flux."}
...
```{r dev-pics7, echo = FALSE, out.width='100%', class = "text-image",fig.show='hold',fig.align='center', fig.cap = "Time series figures of the maps in the zone tracer experiment. Over time the tracer left the linked zones and spread through the model domain."}
