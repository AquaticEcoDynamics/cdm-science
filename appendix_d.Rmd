...
sediment_linkvars <- read_xlsx("tables/sed/SedQualitySamples.xlsx", sheet = "Rapid" )
 kable(sediment_linkvars,"html", escape = F, align = "c", caption = "Rapid assessment criteria, based on Hallet et al. (2019). These samples assessed the grainy or oozy state of the sediment.",
       bootstrap_options = "hover") %>%
   kable_styling(sediment_linkvars, bootstrap_options = "hover", 
                 full_width = F, position = "center", 
                 font_size = 12) %>% 
...
TOC % was converted to organic matter (mmol L^-1^) according to the following rationale:
   - TOC % was measured as kg OC per kg dry sample (and the raw value was divided by 100).
\
